...
El sistema SHALL permitir seleccionar una región/zona GCP desde un catálogo curado para el wizard.
...
El sistema SHALL permitir seleccionar un instance type GCP desde tiers curados orientados a Project Zomboid.
