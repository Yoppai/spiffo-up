# TUI Layout Shell Specification

## Purpose

Define el shell TUI fullscreen reutilizable para el menú global y el Server Dashboard, incluyendo estructura visual, foco entre paneles, navegación base y previews sin side effects remotos.
