# GCP Cloud Catalog Specification

## Purpose

Define el catálogo local de regiones, zonas e instance types GCP para servidores Project Zomboid, incluyendo agrupación por continente, medición de latencia HTTP, tiers curados, catálogo filtrado, costos estimados y recomendación por MaxPlayers.
