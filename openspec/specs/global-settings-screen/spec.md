# Global Settings Screen Specification

## Purpose

Define el panel de configuración global accesible desde el menú global, incluyendo edición de idioma, tema, ruta de backups y persistencia inmediata en SQLite.
