# GCP Pulumi Deploy Specification

## Purpose

Define el provisionamiento real de servidores Project Zomboid en GCP mediante Pulumi Automation API con state local, incluyendo VM, IP estática, firewall, startup script, Docker Compose, deploy/destroy/status y health check.
